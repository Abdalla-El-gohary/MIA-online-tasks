...
def finddirection(img2,rows,cols):
    direction="undefined"
    for i in range (0,rows,1):
        if img2[i,0][0]<50 and img2[i,0][1]<50 and img2[i,0][2]<50:
            cv2.putText(img,'left direction',(0,i+29),font,2,(255,0,0),2)
            print(i,0)
            direction="left"
            break
    if(direction=="undefined"):
        for i in range (0,rows,1):
            if img2[i,cols-1][0]<50 and img2[i,cols-1][1]<50 and img2[i,cols-1][2]<50:
                cv2.putText(img,'right direction',(rows//2 +50,i+29),font,2,(255,0,0),2)
                print(i,cols-1)
                direction="right"
                break
    if(direction=="undefined"):
        cv2.putText(img,'forward direction',(100 ,30),font,1,(255,0,0),1)
...
img2=cv2.imread('images/test3.png')     #get copy of image
